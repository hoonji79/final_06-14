...
//이전 액티비티에서 전달된 데이터 가져오기
        ...
        String name = intent.getStringExtra("name"); //학교
                                    ...
                                    if (task.isSuccessful()) {
                                        ...
                                        try {
                                            if (card_url != null) {   // Image URL 처리
                                                ...
                                                String fileName = userEmail+".jpg"; // 예시 파일명, 실제로는 고유한 파일명을 사용하는 것이 좋습니다.
                                            ...
                                            Intent intent1 = new Intent(join_password.this, join_success.class);
